...
void *generate_struct_c::visit(ref_value_null_literal_c *symbol)  { TRACE("ref_value_null_literal_c");  return NULL;}
...
void *generate_struct_c::visit(neg_real_c *symbol)           { TRACE("neg_real_c"); return print_unary_expression(symbol, symbol->exp, "-");}
void *generate_struct_c::visit(neg_integer_c *symbol)        { TRACE("neg_integer_c"); return print_unary_expression(symbol, symbol->exp, "-");}

void *generate_struct_c::visit(integer_literal_c *symbol)    { TRACE("integer_literal_c"); return print_literal(symbol->type, symbol->value);}
void *generate_struct_c::visit(real_literal_c *symbol)       { TRACE("real_literal_c"); return print_literal(symbol->type, symbol->value);}
void *generate_struct_c::visit(bit_string_literal_c *symbol) { TRACE("bit_string_literal_c"); return print_literal(symbol->type, symbol->value);}
void *generate_struct_c::visit(boolean_literal_c *symbol)    { TRACE("boolean_literal_c"); return print_literal(symbol->type, symbol->value);}

/* helper class for boolean_literal_c */
void *generate_struct_c::visit(boolean_true_c *symbol)       { TRACE("boolean_true_c");  return NULL;}
void *generate_struct_c::visit(boolean_false_c *symbol)      { TRACE("boolean_false_c");  return NULL;}

/*******************************/
/* B.1.2.2   Character Strings */
/*******************************/
void *generate_struct_c::visit(double_byte_character_string_c *symbol) { TRACE("double_byte_character_string_c"); return print_token(symbol);}
void *generate_struct_c::visit(single_byte_character_string_c *symbol) { TRACE("single_byte_character_string_c"); return print_token(symbol);}
...
/* B 1.2.3.1 - Duration */
/************************/
void *generate_struct_c::visit(neg_time_c *symbol) { TRACE("neg_time_c"); return NULL;}
...
void *generate_struct_c::visit(fixed_point_c *symbol) { TRACE("fixed_point_c"); return print_token(symbol);}
...
/********************************/
void *generate_struct_c::visit(generic_type_any_c      *symbol) {TRACE("generic_type_any_c"); return NULL;}
...
void *generate_struct_c::visit(symbolic_constant_c *symbol) {TRACE("symbolic_constant_c"); return symbol->var_name->accept(*this);}

/********************************************/
/* B.1.4.1   Directly Represented Variables */
/********************************************/
void *generate_struct_c::visit(direct_variable_c *symbol) {TRACE("direct_variable_c"); return NULL;}
...
void *generate_struct_c::visit(subscript_list_c *symbol) {TRACE("subscript_list_c"); return NULL; }
